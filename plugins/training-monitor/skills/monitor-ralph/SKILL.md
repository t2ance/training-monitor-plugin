...
4. A reminder to use the /training-monitor skill.
...
Execute the /training-monitor skill directly. Do not wait for the first
cron tick. This validates the setup end-to-end.
